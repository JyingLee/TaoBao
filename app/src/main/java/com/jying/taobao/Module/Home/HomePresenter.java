...
public class HomePresenter implements HomeContract.Presenter {
    ...
    public List<String> getCarouselImages() {
        ...
        list.add("https://gd2.alicdn.com/imgextra/i2/380101244/TB2HHzZdNmJ.eBjy0FhXXbBdFXa_!!380101244.jpg");
        list.add("https://gd4.alicdn.com/imgextra/i4/380101244/TB2qUNua4mI.eBjy0FlXXbgkVXa_!!380101244.jpg");
        list.add("https://gd1.alicdn.com/imgextra/i1/380101244/TB2REFwa9qJ.eBjy1zbXXbx8FXa_!!380101244.jpg");
        list.add("https://gd4.alicdn.com/imgextra/i4/380101244/TB2Ye4taZeK.eBjSszgXXczFpXa_!!380101244.jpg");
        list.add("http://ob9thtnhs.bkt.clouddn.com/tuisong/da386d4d7872451ca346ba6e37da17b6." +
                "jpg?e=1477544913&token=m2BF8x75sZF4DIfwnxFri5sT51HeuFRmU2Ue0uVf:LWGBH77qhKA_BEcdgUA5u5AebR0=");
        return list;
    }

    @Override
    public HomeTop getTopLists() {
        HomeTop homeTop = new HomeTop();
        //模拟返回数据
        int spanCount = 300;

        List<HomeBase> headlineList = new ArrayList<>();
        headlineList.add(new HomeBase(6, 0, "", "仿Github:EasyToForget", HomeBase.TYPE_HEADLINE, spanCount));
        headlineList.add(new HomeBase(7, 0, "", "Github:JyingLee", HomeBase.TYPE_HEADLINE, spanCount));
        headlineList.add(new HomeBase(8, 0, "", "Email:853281682@qq.com", HomeBase.TYPE_HEADLINE, spanCount));
        ...
        mView.showTop(homeTop);
        return homeTop;
    }

    @Override
    public HomeBottom getBottomLists(int page) {
